...
export type CreatePositionFormValues = z.input<typeof createPositionFormSchema>;
export type CreatePositionFormOutput = z.output<typeof createPositionFormSchema>;
