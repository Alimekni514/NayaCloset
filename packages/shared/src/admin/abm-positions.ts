...
export const abmPositionSortDirectionValues = ['asc', 'desc'] as const;
export const abmPositionPageSizeValues = [10, 20, 50] as const;
...
export type AbmPositionStatusCategory = z.infer<typeof abmPositionStatusCategorySchema>;
export type AbmPositionsQuery = z.infer<typeof abmPositionsQuerySchema>;
export type AbmPositionListItem = z.infer<typeof abmPositionListItemSchema>;
export type AbmPositionsResponse = z.infer<typeof abmPositionsResponseSchema>;
export type AbmPositionDeleteResponse = z.infer<typeof abmPositionDeleteResponseSchema>;
export type AbmPositionSortBy = (typeof abmPositionSortByValues)[number];
export type AbmPositionSortDirection = (typeof abmPositionSortDirectionValues)[number];

export interface PositionListLocalFilters {
  search: string;
  status: string;
  service: string;
  governorate: string;
  sortBy: AbmPositionSortBy;
  sortDirection: AbmPositionSortDirection;
  page: number;
  pageSize: number;
}
