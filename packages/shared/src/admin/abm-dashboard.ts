...
export const abmDashboardQuerySchema = z
  ...
  .refine(
    (value) =>
      !value.from || !value.to || new Date(`${value.from}T00:00:00.000Z`) <= new Date(`${value.to}T00:00:00.000Z`),
    {
...
export type AbmDashboardGroup = z.infer<typeof abmDashboardGroupSchema>;
export type AbmDashboardQuery = z.infer<typeof abmDashboardQuerySchema>;
export type AbmDashboardEvent = z.infer<typeof abmDashboardEventSchema>;
export type AbmDashboardTotals = z.infer<typeof abmDashboardTotalsSchema>;
export type AbmDashboardResponse = z.infer<typeof abmDashboardResponseSchema>;
